 ...
 */
class WebProjectFactoryTest extends \PHPUnit_Framework_TestCase
{

    public function testWebFactory()
    {
        ...
        $this->assertInstanceOf('Synergy\Project\Web\WebProject', $project);
        $project->run();
    }
}